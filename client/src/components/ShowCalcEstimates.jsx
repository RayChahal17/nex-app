...
export default function ShowCalcEstimates() {
  ...
  const [statusOptions] = useState(['All', 'Pending', 'In Progress', 'Completed', 'Cancelled', 'Provided', 'Successful', 'Failed', 'Inconsequential', 'Waiting', 'Job Completed']);
  ...
  const renderEstimateDetails = () => {
    ...
    const { customerInfo, sections, additionalCosts = {}, stairs, costPerSqFeet, discount, discountType, finalEstimate, discountedEstimate, serviceType } = selectedEstimate;
    const hst = 0.13;
    ...
    return (
      <Modal show={!!selectedEstimate} onClose={() => setSelectedEstimate(null)}>
